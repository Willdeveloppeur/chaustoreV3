 ...
 * Product
 *
 * @ORM\Table(name="product", indexes={@ORM\Index(name="product_brand", columns={"brand_id"}), @ORM\Index(name="product_category", columns={"category_id"}), @ORM\Index(name="product_color", columns={"color_id"}), @ORM\Index(name="name", columns={"name"})})
 * @ORM\Entity
 */
class Product
{
     ...
     * @var string
     *
     * @ORM\Column(name="price", type="decimal", precision=5, scale=2, nullable=false, options={"default"="0.00"})
     */
    private $price = '0.00';
